...
<body>       
         ...
         <img src="/Imagenes/Vector4.png" class="Vector-4"/> 
             ...
             <form id="form1" runat="server">
                    ...
                    <div class="formulario-barra"><asp:TextBox ID="TextBox1" runat="server" class="completar-email" AutoComplete="off"></asp:TextBox></div>
                    <h3 class="formulario-contraseña">Contraseña:</h3>
                    <div class="formulario-barra2"><asp:TextBox ID="TextBox2" type="password" runat="server" class="completar-email" AutoComplete="off"></asp:TextBox></div>
